...
#
#based on the version: https://github.com/IHP-GmbH/IHP-Open-PDK/commit/25e02ffd15555380e6b8dd2e0f4108ef537e1fa6
#
#changelog:
#   Author        Modification
# ------------  -------------------------------------------------
# He.Zeng      The `#groupId.append(inner)` line is commented out
#
#
########################################################################
