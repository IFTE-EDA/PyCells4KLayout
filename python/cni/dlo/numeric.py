...
#
#
# CHANGELOG: based on the version:https://github.com/IHP-GmbH/IHP-Open-PDK/commit/cdbc05f32c8eb84af717230c38610571a66b0939
#
#   Author        Modification
# ------------  -------------------------------------------------
# He.Zeng      Add methods: __int_ ,__sub__, __add__,__eq__, is_integer, __index__
# 
#
########################################################################
...
class Numeric(float):
    ...
    part of the code is from IHP OpenPDK
    ...
    def _calcValue(cls, value):
        ...
        try:
            ...
            print("numberPart",numberPart, type(numberPart))
        except:
            raise ValueError
    ...
    def scaleFormat(self, scaleFactor = None):
        ...
        if scaleFactor is not None:
            if type(scaleFactor) is str:
                ...
                f"{self._numberPart}{self._scaleFactor}"
                #return calcValue
        else:
            #return self
    ...
    #return value  # already been tested.       
    def __int__(self):
    ...
    def __add__(self, other):
        if isinstance(other, Numeric):
            ...
            raise ValueError("do supprot add Numeric with string")
        elif isinstance(other, (float, int)):
            return float(self) + other
        else:
            raise TypeError(f"current only support: Numeric int float as argument")
    ...
    # already been tested.  
    def is_integer(self): 
        return super(Numeric, self).is_integer()
